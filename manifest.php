...
$actionRows[0]["precedence"]="6";
$actionRows[0]["category"]="ARR" ;
$actionRows[0]["description"]="Manage housekeeping functions" ;
$actionRows[0]["URLList"]="index.php, admin.php, admin_access.php, admin_assign.php, admin_complete.php, admin_criteria.php, admin_define.php, admin_design.php, admin_startyear.php" ;
